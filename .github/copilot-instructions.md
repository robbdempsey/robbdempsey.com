...
- use functional programing patterns.
- spec file naming convention v<semantic version>-< feature/research topic >.spec.md
- spec semantic version should follow the current package.json version


## Things to do

- read the appropriate instructions before modifying any code.
- think about the problem you have been asked to solve.
